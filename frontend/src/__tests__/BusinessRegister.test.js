...
import BusinessRegister from '../components/BusinessReigster';
import api from '../Api'
...
beforeEach(() => {
    ...
    wrapper = shallowMount(BusinessRegister, {
        propsData: {},
        mocks: {},
        stubs: {},
        methods: {},
...
//TESTS TO CHECK BUSINESS REGISTRATION ERROR HANDLING
describe('Business registration error checking', () => {
