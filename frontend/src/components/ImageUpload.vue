<template>
    <div>
        ...
        <label ref="loadableButton" @click="clickedButton=true" id='imageSelectBtn' for="fileUpload" class="btn">Upload image</label>
...
const ImageUpload = {
  ...
  mounted() {
      //Add event listener for id fileUpload, sort've hacky as upload image will be called on all instances of this component
      document.getElementById('fileUpload').addEventListener('change', this.uploadImage);
  },
