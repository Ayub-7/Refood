...
<!--                Add select with business types-->
                <div class="vert-row">
                <h3 class="filter-label">
                  Business Name:
                </h3>
              ...
              <div class="parameter" id="product">
                <div class="vert-row">
                <h3 class="filter-label">
                  Product Name:
                </h3>
                <vs-input class="filter-input" type="search" placeholder="Product name.." name="searchbarUser"  style="width: 400px; font-size: 24px" size="small"/>
                <!--                Add select with business types-->
              </div>
              <div class="vert-row">
                <h3 class="filter-label">
                ...
                <vs-input class="price-input" type="search" placeholder="Min" name="searchbarUser"  style="width: 400px; font-size: 24px" size="small"/>
                <vs-input class="price-input" type="search" placeholder="Max" name="searchbarUser"  style="width: 400px; font-size: 24px" size="small"/>
                <!--                Add select with business types-->
              </div>
              </div>
            ...
            <div id="sort-container">
              <div>
                ...
                <vs-button class="sort-btn" @click="sortByName(null, selected, 0);" style="width: 100px">Sort</vs-button>
                </div>
                </div>
            </div>
          </div>
