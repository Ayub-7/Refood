...
class ListingControllerTest {
  ...
  @MockBean private ProductFinder productFinder;
  ...
  public void setup() throws NoSuchAlgorithmException {
    ownerUser =
        new User(
            ...
            "+7 684 622 5902",
            new Address(
                "32", "Little Fleur Trail", "Christchurch", "Canterbury", "New Zealand", "8080"),
            "ATQWJM");
    ownerUser.setId(1L);
    user =
        new User(
    ...
    adminUser =
        new User(
            ...
            "Tynemouth",
            "Exclusive",
            "6th generation intranet",
            "gtynemouth1@indiatimes.com",
            "1996-03-31",
            "+62 140 282 1784",
            new Address(
                "32", "Little Fleur Trail", "Christchurch", "Canterbury", "New Zealand", "8080"),
    ...
    business =
        new Business(
            "Business1", "Test Business 1", a1, BusinessType.ACCOMMODATION_AND_FOOD_SERVICES);
    business.setId(1L);
    ...
    inventory1 =
        new Inventory("07-4957066", 1, 10, 2.0, 20.0, beforeDate, laterDate, laterDate, laterDate);
    newListingRequest = new NewListingRequest(inventory1.getId(), 2, 2.99, "more info", laterDate);
    listing1 =
        new Listing(
            inventory1, 5, 2.0, "Seller may be interested in offers", new Date(), laterDate);
    ...
    listing2 =
        new Listing(
            ...
            10,
            10.0,
            "Seller may be interested in offers",
            new Date(),
            anotherLaterDate);
  ...
  void testSuccessfulGetBusinessListings() throws Exception {
    ...
    mvc.perform(
            get("/businesses/{id}/listings", business.getId())
  ...
  void testForbiddenUserPostListing() throws Exception {
    ...
    Mockito.when(productRepository.findProductByIdAndBusinessId(null, business.getId()))
        .thenReturn(product1);
    Mockito.when(inventoryRepository.findInventoryById(inventory1.getId())).thenReturn(inventory1);

    mvc.perform(
            post("/businesses/{id}/listings", business.getId())
  ...
  void testSuccessfulPostListingAsBusinessAdmin() throws Exception {
    ...
    Address addr = new Address(null, null, null, null, null, "Australia", "12345");
    User businessSecondaryAdmin =
        new User("New", "User", addr, "email@email.com", "password", Role.USER);
