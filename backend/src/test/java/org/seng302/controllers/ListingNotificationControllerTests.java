...
public class ListingNotificationControllerTests {
    ...
    void setup() throws NoSuchAlgorithmException {
        ...
        listing2.setId(2L);
        boughtListing1 = new BoughtListing(user, listing.getInventoryItem().getProduct(), listing.getLikes(), listing.getQuantity(), listing.getCreated());
        boughtListing2 = new BoughtListing(user, listing2.getInventoryItem().getProduct(), listing2.getLikes(), listing2.getQuantity(), listing2.getCreated());
