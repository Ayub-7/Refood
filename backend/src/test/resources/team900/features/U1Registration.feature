Feature: U1 Registering and logging into an individual account
  ...
  When They input the firstname "Jeff", lastname "Goldstein", email "jeffgold@hotmail.com", DoB "19/04/1998", and password "Potato1!"
  ...
  Given User attempts to register
  When They input the firstname "", lastname "", email "jeffgold@hotmail.com", DoB "19/04/1998", and password "Potato1!"
  ...
  Given User attempts to register
  When They input the firstname "Kyle", lastname "Jonathan", email "kyle@@b0..com", DoB "19/04/1998", and password "Potato1!"
  Then They are notified that they need to enter a valid email

  Scenario: Registration with a blank email
  Given User attempts to register
  When They input the firstname "Kyle", lastname "Jonathan", email "", DoB "19/04/1998", and password "Potato1!"
  Then They are notified that they need to enter a valid email

  Scenario: Underage registration
  Given User attempts to register
  When They input the firstname "Jeff", lastname "Goldstein", email "jeffgold@hotmail.com", DoB "19/04/2018", and password "Potato1!"
