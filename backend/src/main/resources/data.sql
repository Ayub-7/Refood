...
/* MARIADB FUNCTION: SHA2(password, 256); */
...
INSERT INTO product (id, name, description, manufacturer, recommended_retail_price, created, business_id) VALUES
    /* 20 products */
    ('WAUEH98E37A680027', 'Wine - White, Pinot Grigio', 'integer ac leo pellentesque ultrices mattis odio donec vitae nisi nam ultrices libero non mattis pulvinar integer ac leo pellentesque ultrices mattis odio donec vitae nisi nam ultrices libero non mattis pulvinar integer ac leo pellentesque', 'Bubbletube', 51.63, '2021-01-27 16:07:14', 1),
    ('WAUVT64B54N722288', 'Pastry - Cheese Baked Scones', 'amet erat nulla tempus vivamus', 'Watties', 19.88, '2021-03-05 14:36:54', 1),
    ('KNDJT2A29D7324794', 'Beef - Ground Lean Fresh', 'vestibulum ante ipsum primis in faucibus', 'Watties', 59.43, '2021-02-06 20:17:16', 1),
    ...
    ('SCFEBBCF6CG218162', 'Yogurt - Blueberry, 175 Gr', 'nec nisi volutpat eleifend donec ut dolor morbi vel lectus in quam fringilla rhoncus mauris enim leo', 'Gabcube', 72.83, '2021-01-15 16:56:26', 1),
    ('WBAPM7C51AE969438', 'Longos - Lasagna Veg', 'a pede posuere nonummy integer non velit donec diam neque vestibulum eget vulputate ut ultrices vel augue vestibulum ante ipsum', 'Skimia', 36.81, '2021-03-04 03:38:04', 1),
    ('5UXWX7C53EL958298', 'Ice Cream Bar - Drumstick', 'eu mi nulla ac enim', 'Formula Foods', 50.2, '2021-01-01 07:57:56', 1),
    ('WBAVD33586K975326', 'Peas Snow', 'porttitor pede justo eu massa donec dapibus duis at velit eu est congue elementum', 'Peapea Foods', 73.9, '2021-04-06 19:28:28', 1),
    ('5NPDH4AE0EH887279', 'Cheese - Pied De Vents', 'eget congue eget semper rutrum nulla nunc purus phasellus in felis donec semper sapien a libero nam dui', 'Food Food Food', 36.65, '2021-01-24 21:22:47', 1),
    ('2C3CDZFJ2FH936197', 'Sherbet - Raspberry', 'justo sollicitudin ut suscipit a feugiat et eros vestibulum ac est', 'Sherbet Co', 86.18, '2021-01-28 19:33:16', 1),
    ('WBAUP9C53DV435366', 'Energy Drink', 'ipsum dolor sit amet consectetuer adipiscing elit proin', 'Coca-Cola', 91.48, '2021-03-04 02:58:24', 1),
    ('YV1612FS9E2422348', 'Bread Base - Gold Formel', 'condimentum neque sapien placerat ante nulla justo', 'Coopolandes', 29.81, '2021-01-08 21:31:51', 1),
    ('WAUMF98KX9A331487', 'Chicken - White Meat With Tender', 'in eleifend quam a odio in hac habitasse platea dictumst maecenas ut massa quis augue luctus', 'Chicken Little Ltd', 30.91, '2021-01-03 04:39:36', 1),
    ('5UXFG8C5XAL953759', 'Yogurt - Strawberry, 175 Gr', 'justo lacinia eget tincidunt eget tempus vel pede morbi porttitor lorem id ligula suspendisse ornare consequat', 'Formula Foods', 95.84, '2021-02-10 6:35:49', 1),
    ('WAUJC58E75A227743', 'Fish - Scallops, Cold Smoked', 'rutrum at lorem integer tincidunt ante vel ipsum praesent blandit lacinia erat vestibulum sed', 'United Fisheries', 65.12, '2021-02-03 19:00:32', 1),
    ('1N6AA0CA2AN447971', 'Wine - Bouchard La Vignee Pinot', 'bibendum morbi non quam nec dui luctus rutrum nulla tellus in sagittis dui', 'Lorem Ipsum', 41.35, '2021-03-16 16:26:06', 1),
    ('SCBDR3ZA2BC827880', 'Nestea - Iced Tea', 'a suscipit nulla elit ac nulla sed vel enim sit amet nunc viverra dapibus nulla suscipit ligula in lacus curabitur', 'Pepsico', 24.27, '2021-01-27 18:14:57', 1),
    ('WAUUL98E96A125348', 'Calvados - Boulard', 'quis lectus suspendisse potenti in eleifend quam a', 'Vegesdirect', 9.03, '2021-01-25 22:18:45',1),
    ('JN8AF5MR1ET433412', 'Juice - Pineapple, 341 Ml', 'ridiculus mus etiam vel augue vestibulum', 'Juicelord', 2.66, '2021-03-09 22:56:37', 1),
    ('WAUEH78E77A454448', 'Bread - Focaccia Quarter', 'orci vehicula condimentum curabitur in libero', 'Bread Company', 22.34, '2021-04-05 18:35:12', 1),
    ('WAUEH78E77A454449', 'Bread - White', 'orci vehicula condimentum curabitur in libero', 'Bread Company', 22.34, '2021-04-05 18:35:12', 1),
    ('WAUEH78E77A454450', 'Bread - Toasted', 'orci vehicula condimentum curabitur in libero', 'Bread Company', 22.34, '2021-04-05 18:35:12', 1),
    ('WAUEH78E77A454451', 'Bread - Thicc', 'orci vehicula condimentum curabitur in libero', 'Bread Company', 22.34, '2021-04-05 18:35:12', 1),
    ('WAUEH78E77A454452', 'Bread - Loafed', 'orci vehicula condimentum curabitur in libero', 'Bread Company', 15.80, '2021-04-05 18:35:12', 1),
    ('WAUEH78E77A454453', 'Bread - Burnt', 'orci vehicula condimentum curabitur in libero', 'Bread Company', 2.34, '2021-04-05 18:35:12', 1);
...
INSERT INTO inventory (best_before, business_id, expires, manufactured, price_per_item, product_id, quantity, sell_by, total_price) VALUES
    ('2021-05-27T12:00:00Z', 1, '2021-05-27T12:00:00Z', '2021-01-27T12:00:00Z', 5.00, 'WAUVT64B54N722288', 10, '2021-05-25T12:00:00Z', 50.00),
    ...
    ('2021-08-27T12:00:00Z', 1, '2021-10-27T12:00:00Z', '2021-01-27T12:00:00Z', 1.00, 'WAUVT64B54N722288', 9, null, 50.00),
