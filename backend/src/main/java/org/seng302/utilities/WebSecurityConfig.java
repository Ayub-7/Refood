    ...
    protected void configure(final HttpSecurity http) throws Exception {
        ...
        http
                ...
                .and()
                 ...
                 .antMatchers("/users/**", "/users/{id}/likes", "/messages", "/messages/**").authenticated()
                 .antMatchers("/businesses", "/businesses/**", "/businesses/listings/{id}/like", "/cards", "/cards/**", "/actasbusiness").authenticated()
