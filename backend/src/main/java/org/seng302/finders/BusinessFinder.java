...
public class BusinessFinder {
     ...
     */
    private Specification<Business> buildBusinessSpec(String query) {
     ...
     */
    public Specification<Business> findBusinesses(String query) {
        Specification<Business> matches = buildBusinessSpec(query);
        return matches;
//        return businessRepository.findAll(matches);
    }
}
